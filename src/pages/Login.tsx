...
import { Eye, EyeOff, ShieldAlert, Mail, ArrowLeft } from 'lucide-react';
              ...
              <div className="animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="flex justify-center mt-2">
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 text-theme-text/60 hover:text-theme-text/90 transition-colors text-[13px] font-medium py-2 px-4 rounded-lg hover:bg-theme-border/50"
                  >
             ...
             <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="flex items-center mb-5">
                  <button 
                    ...
                    className="flex items-center gap-2 text-theme-text/60 hover:text-theme-text/90 transition-colors text-sm font-bold uppercase tracking-wider bg-theme-border/30 hover:bg-theme-border/60 py-1.5 px-3 rounded-md"
                  >
